# AIDB Episode Share-Leverage Rubric (v0.1)
...
Most podcast growth playbooks treat episodes as a uniform pipeline. They aren't. Roughly 20% of episodes drive ~80% of organic sharing. This rubric front-loads the selection question so packaging effort lands where it compounds.

A Growth Engineer's first job at AIDB isn't packaging every episode well. It's deciding which episodes deserve packaging at all, packaging those hard, and feeding the pattern back so editorial has signal.

## The seven dimensions

Each scored 0–3. Max raw score: 21. Packaging bar: ≥15. Below 12: skip or repurpose.

| # | Dimension | What it asks |
|---|---|---|
| 1 | Identity Activation | Does it hand the listener a label they want to claim publicly? |
| 2 | Counter-Narrative Density | Is NLW reframing something most people half-believe wrongly? |
| 3 | Single Archetype Fit | Is there ONE clear receiver (CMO, PT, founder, ops lead)? |
| 4 | Quotable Crystallization | Is there a 1–2 line statement that survives screenshot extraction? |
| 5 | Defensibility Tool | Does it give the sharer vocabulary for an argument they're already having? |
...
## Rollout plan after hiring

| Week | Work |
|---|---|
| 1 | Score all 2026-to-date episodes from titles + show notes. v0 ranking. |
| 2 | Pull real share data (X reposts, LinkedIn shares, Spotify share rate, Apple share rate, listener-survey "did you forward this" signal). Retrofit the rubric against actual data. Discard or reweight dimensions that don't correlate. |
| 3 | v1 rubric. Package only top-quintile episodes going forward. Measure share-rate lift vs baseline. |
| 4 | Surface the v1 rubric to editorial as data, not direction. |
